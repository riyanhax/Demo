...
App.Director = function()
{
	...
	window.setInterval(function(){
			delete App.Preload.assets;
			App.Preload.assets = {};

			var parseData = new App.ParseData();
			parseData.loadAirport();
			parseData.loadWeather();
			parseData.loadFacility();
			parseData.loadOndutyPeople();
			parseData.loadAirportinfo();
			parseData.loadSectorArea();
  			parseData.loadDelaySectorArea();
  			parseData.loadDelayRoutes();
			parseData.loadrouteinfo();
			parseData.loadRoutes();		
	},60000);
}
