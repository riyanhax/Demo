(function($) {
  ...
  var flipTimer = function(element, options) {
    ...
    options.end = this.element.data('end');
    this.userOptions = options;

    var color =  this.element.data('color') || '#00b8f6';
    ...
    this.defaultOptions = {
        ...
        digitTemplate: '' +
          '<div class="digit">' +
          '  <div class="digit-top" style="background-color:'+color+';">' +
          '    <span class="digit-wrap"></span>' +
          '  </div>' +
          '  <div class="digit-bottom" style="background-color:'+color+';">' +
          '    <span class="digit-wrap"></span>' +
          '  </div>' +
          '</div>'
    };
  ...
  flipTimer.prototype = {
    ...
    startTimer: function() {
      ...
      this.timer = setInterval(function() {
        ...
        if(_this.seconds>=_this.options.end){
          clearInterval(_this.timer);
          return;
        }
...
/*        if (_this.seconds == 9 || _this.seconds == -1) {
