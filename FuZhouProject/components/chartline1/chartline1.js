;(function(window,document,undefined){
    function Chartline1(ops){
        ...
        var indexMum=0;
        var LinearColor=[];
        var dataValue=[10,20,12,25,18];
        function indexMun(){
        	if(indexMum<=0.99){
        		LinearColor.push(
        			{
	                    offset: indexMum,
	                    color: 'rgba(51, 173, 206,0.4)'
	                },
	                {
	                    offset: indexMum+0.01,
            ...
            series: [
                {
		            ...
		            itemStyle: {
		            	normal: {
		            		areaStyle: {
		            			type: 'default',
		            			color: new echarts.graphic.LinearGradient(0, 0, 1, 0,LinearColor, false)
		            		}
		            	}
		            },
		            data:[
