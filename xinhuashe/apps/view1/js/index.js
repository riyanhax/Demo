...
;(function(window,document,undefined){
	...
	function loading(){
		var app = new PIXI.Application(561,88,{ antialias: true ,backgroundColor:0x131126});
		...
		function drawLoading(scale,x,color){
		...
		for(var i=0;i<colors.length;i++){
			drawLoading(colors[i].scale,70*i,colors[i].color);
		}
	...
	function chartRight(data,res){
		...
		var app = new PIXI.Application(700, 565, { antialias: true ,backgroundColor:0x131126});
	...
	function chartLeft(data){
		var app = new PIXI.Application(482, 482, { antialias: true ,backgroundColor:0x131126});
